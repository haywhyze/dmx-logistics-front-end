      ...
      <div className='main' 
        ...
        {({ errors, touched, values, isSubmitting }) => {
            ...
            <div style={{display: 'flex', justifyContent: 'space-around'}}>
              <div style={{ marginTop: '0' }} className="ui compact segment black">
            ...
            <div className={ errors.password && touched.password ? "field error" : "field" }>
             ...
             <div> {
                values.userRole === 'business' && (
                  <div className={ errors.businessName && touched.businessName ? "field error" : "field" }>
                    <label>
                      Business Name
                      <Field name="businessName" placeholder='Almond Clothiers' />
              ...
              <div style={{ display: 'flex', justifyContent: 'center'}}>
                <Button loading={isSubmitting} type="submit" className="dmx-color">Sign Up</Button>
              </div>
            </Form> );
          }}
        </Formik>
