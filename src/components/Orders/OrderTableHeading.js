...
export default ({ heading, orders, orderBy }) => {
  ...
  return(
    <h1 style={{textAlign: 'center', marginTop: '2rem'}}>No order to display <Link to='/new'>Click here</Link> to make a new other</h1>
  )
}